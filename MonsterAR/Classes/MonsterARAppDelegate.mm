...
@implementation MonsterARAppDelegate
...
-(void) establishDirectorController {
	...
	[_viewController enableRetinaDisplay: NO];
}
#endif
...
-(void) applicationDidFinishLaunching: (UIApplication*) application {
    ...
    [qUtils createARofSize:arViewSize forDelegate:nil];
	...
	CC3Layer* cc3Layer = [MonsterARLayer layerWithController: _viewController];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [MonsterARScene scene];
